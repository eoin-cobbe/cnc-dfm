...
DEFAULTS = {
    ...
    "complexity_penalty_per_face": 0.002,
    "complexity_penalty_max_multiplier": 1.5,
    "complexity_baseline_faces": 6,
...
FIELDS: List[Tuple[str, str, str, str]] = [
    ...
    ("surface_penalty_slope", "Part", "Surface-area penalty slope", "float"),
    ("surface_penalty_max_multiplier", "Part", "Surface-area penalty max multiplier", "float"),
    ("complexity_penalty_per_face", "Part", "Complexity penalty per face", "float"),
    ("complexity_penalty_max_multiplier", "Part", "Complexity penalty max multiplier", "float"),
    ("complexity_baseline_faces", "Part", "Complexity baseline faces", "int"),
...
CLI_FLAGS = {
    ...
    "complexity_penalty_per_face": "--complexity-penalty-per-face",
    "complexity_penalty_max_multiplier": "--complexity-penalty-max-multiplier",
    "complexity_baseline_faces": "--complexity-baseline-faces",
